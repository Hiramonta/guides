...
curl -Ls https://snap.hiramonta.com/allora-testnet/genesis.json > $HOME/.allorad/config/genesis.json
curl -Ls https://snap.hiramonta.com/allora-testnet/addrbook.json > $HOME/.allorad/config/addrbook.json
```
...
sed -i -e "s|^seeds *=.*|seeds = \"d1d43cc7c7aef715957289fd96a114ecaa7ba756@testnet-seeds.hiramonta.com:24610\"|" $HOME/.allorad/config/config.toml
```
...
curl -L https://snap.hiramonta.com/allora-testnet/allora-latest.tar.lz4 | tar -Ilz4 -xf - -C $HOME/.allorad
